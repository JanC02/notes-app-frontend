...
export default function NotesLayout() {
    ...
    return <>
        <header className='z-1 sticky top-0 min-h-11 lg:min-h-13 flex items-center justify-between gap-x-4 px-4 bg-emerald-500 shadow-[0_4px_16px_rgba(0,0,0,0.35)] text-[#f7f7f7]'>
